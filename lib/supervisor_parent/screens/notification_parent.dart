...
class NotificationsParent extends StatefulWidget {

  @override
  _NotificationsParentState createState() => _NotificationsParentState();
}

class _NotificationsParentState extends State<NotificationsParent> {
  ...
  Widget build(BuildContext context) {
    List<NotificationMessage> notifications = [
      NotificationMessage(
          ...
          messageType: "Arrival Reminder".tr,
          messageTime: '07:35 ',
          messageTimes: 'AM'.tr
      ),
      NotificationMessage(
          messageContent:
              "Joly’s Bus has left from school, it will reach location in 35 mins".tr,
          messageType: "Taken From School".tr,
          messageTime: '02:45 ',
          messageTimes: 'AM'.tr,
      ),
      NotificationMessage(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                EdgeInsets.only( right: 70, top: 2),
                                child: Column(
                                  children: [
                                    Image.asset(
