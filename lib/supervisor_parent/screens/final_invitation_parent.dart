...
class FinalAcceptInvitationParent extends StatefulWidget {
  const FinalAcceptInvitationParent({super.key});

  @override
  State<FinalAcceptInvitationParent> createState() => _FinalAcceptInvitationParentState();
}

class _FinalAcceptInvitationParentState extends State<FinalAcceptInvitationParent> {
  ...
  void initState() {
    ...
    Timer(Duration(milliseconds: 500), (){
      Navigator.push(context, MaterialPageRoute(builder: (context) => MapParentScreen()));
    });
  }
  @override
