...
class SettingsParent extends StatefulWidget {
  @override
  _SettingsParentState createState() => _SettingsParentState();
}

class _SettingsParentState extends State<SettingsParent> {
