    ...
    await _auth.verifyPhoneNumber(
     ...
     //   await _auth.signInWithCredential(credential);
      ...
      codeSent: (String verificationId, int? resendToken) async {
        ...
        Navigator.push(context,MaterialPageRoute(builder: (context)=>OtpScreen(type: selectedContainer,verificationId: verificationId,name:_name.text,phone:'0'+_phoneNumberController.text,typeName: typeAccount,)) );
      },
      codeAutoRetrievalTimeout: (String verificationId) {},
      timeout: Duration(seconds: 60),
    );
                                      ...
                                      Align(
                                        ...
                                        child: ElevatedSimpleButton(
                                          ...
                                          onPress: () async {
                                            ...
                                            bool isNumberExits = await checkIfNumberExists('0'+_phoneNumberController.text);
                                            setState(() {
